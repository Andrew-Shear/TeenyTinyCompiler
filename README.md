...
The grammar for this language is very simple, as it has very few features, but it will be updated as the featureset grows. Example programs can be found in the `/examples` directory.
